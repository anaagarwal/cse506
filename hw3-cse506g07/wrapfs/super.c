...
/*  			EXTRA_CREDIT_1
 * Added New- Debug option enabled for super block operation 
 * in the respective function.Two printk enabled in function
 * wherever necessary.
 */
...
static void wrapfs_put_super(struct super_block *sb)
{
  ...
  debug_super_block_ops(WRAPFS_SB(sb)->debug_super_block_ops,"Debug_wrapfs_put_super");
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(dentry->d_sb)->debug_super_block_ops,"Debug_wrapfs_statfs_super");
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(dentry->d_sb)->debug_super_block_ops,"err : %d", err);
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(sb)->debug_super_block_ops,"Debug_wrapfs_remount_fs_super");
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(sb)->debug_super_block_ops,"err : %d", err);
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(inode->i_sb)->debug_super_block_ops,"Debug_wrapfs_evict_inode_super");
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(sb)->debug_super_block_ops,"Debug_wrapfs_alloc_inode_super");
#endif
...
{
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(inode->i_sb)->debug_super_block_ops,"Debug_destroy_inode_super");
#endif
...
#ifdef EXTRA_CREDIT_1
  debug_super_block_ops(WRAPFS_SB(sb)->debug_super_block_ops,"Debug_wrapfs_umount_begin_super");
#endif
